<template>
    <header class="bg-white p-4 sm:p-6 mb-8 border rounded" v-if="user">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <div class="text-sm text-gray-600 dark:text-gray-400">Joined {{ formatDate(user.created_at) }}</div>
            </div>
            <div class="ml-auto" v-if="isMe">
                <button @click="edit" class="bg-white text-indigo-500 border hover:bg-indigo-500 hover:text-white hover:border-indigo-600 font-bold tracking-tight px-4 py-2 rounded">
                    Edit profile
                </button>
            </div>
